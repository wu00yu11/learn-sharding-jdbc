/*
 ...
 Date: 17/09/2020 17:35:29
*/

drop database  if exists ds1;
create database ds1 charset utf8mb4;
use ds1;
-- ----------------------------
...
CREATE TABLE `t_user_application`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1100 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
